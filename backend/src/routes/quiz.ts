 ...
 * @desc    Generates a new quiz from a set of documents.
 * @access  Private
 */
 ...
 * @desc    Gets a summary of recent quizzes for the user.
 * @access  Private
 */
 ...
 * @desc    Gets the full details of a specific quiz.
 * @access  Private
 */
...
/**
 * @route   POST /api/quiz/:quizId/save-progress
 * @desc    Saves the user's answers and time remaining for an active quiz.
 * @access  Private
 */
 ...
 * @desc    Submits a quiz, calculates the score, and marks it as completed.
 * @access  Private
 */
